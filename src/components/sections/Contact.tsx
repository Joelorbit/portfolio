            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">eyuel.getachew@example.com</span>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="text-gray-600 hover:text-purple-600 dark:text-gray-400 dark:hover:text-purple-400">
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm-1 15h-2v-6h2v6zm-1-7a1 1 0 100-2 1 1 0 000 2zm8 7h-2v-4c0-.5-.5-1-1-1s-1 .5-1 1v4h-2v-6h2v1h.1c.2-.3.6-1 1.9-1 1.6 0 2 1.2 2 2.5V17z" clipRule="evenodd" />
                    </svg>
                  </a>
                </div>
              </div>
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full px-6 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors duration-300 shadow-md"
                  >
                    Send Message
                  </button>
                </div>
